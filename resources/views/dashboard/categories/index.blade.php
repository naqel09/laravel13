                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/dashboard/categories/{{ $category->slug }}/edit" class="btn btn-sm btn-outline-warning me-1" title="Edit"><i class="bi bi-pencil"></i></a>
                                <a href="/dashboard/categories/{{ $category->slug }}" class="btn btn-sm btn-outline-info me-1" title="Detail"><i class="bi bi-eye"></i></a>
